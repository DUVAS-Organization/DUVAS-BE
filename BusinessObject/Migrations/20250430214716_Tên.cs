            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LandlordLicenseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AnhCCCDMatTruoc = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AnhCCCDMatSau = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CCCD = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
                    AnhCCCDMatTruocIV = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    AnhCCCDMatSauIV = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
