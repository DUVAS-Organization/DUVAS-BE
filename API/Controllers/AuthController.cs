    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> LoginGoogle([FromQuery] String code)
        {
            try
            {
                ...
                if (user.RoleUser != 1)
                {
                    return Redirect("https://blue-field-0c1caa000.6.azurestaticapps.net/Logins?error=" + Uri.EscapeDataString("Tài khoản đã bị khóa. Vui lòng liên hệ hotline để mở khóa tài khoản"));
                }
                ...
                return Redirect("https://blue-field-0c1caa000.6.azurestaticapps.net/Logins?error=" + Uri.EscapeDataString("Tài khoản không có quyền đăng nhập. Vui lòng liên hệ quản trị viên."));
            }
            catch (Exception ex)
            {
                return Redirect("https://blue-field-0c1caa000.6.azurestaticapps.net/Logins?error=" + Uri.EscapeDataString($"Đăng nhập thất bại: {ex.Message}"));
            }
        }
